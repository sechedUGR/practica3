...
private:
   ...
   static int getInitialWindowWidth();
   static int getInitialWindowHeight();
   ...
   /**
    * se generan todas las posiciones seguras
    * @param map
    */
   static void generateSafePositions(map<Box, vector<Vector2i>>& map);
    ...
    */
   static void generateNormalPositions(map<Box, vector<Vector2i>>& map, int boxId, int lastBoxId,
    ...
    * @param horizontal
    */
   static void generateFinalCorridorPositions(map<Box, vector<Vector2i>>& map, color col, int x, int dx, int y, int dy,
                                              bool horizontal);
    ...
    * @param map
    */
   static void generateFinalCorridorsPositions(map<Box, vector<Vector2i>>& map);

   /**
    * genera las posiciones de las fichas en casa
    * @param map
    * @param col
    */
   static void generateHomePositions(map<Box, vector<Vector2i>>& map);
    ...
    * @param col
    */
   static void generateGoalPositions(map<Box, vector<Vector2i>>& map);

   /**
    * genera todas las celdas normales del tablero
    * @param map
    */
   static void generateNormalPositions(map<Box, vector<Vector2i>>& map);

   /**
    * genera todas las posiciones del tablero
    * @return
    */
   static map<Box, vector<Vector2i>> generatePositions();
