...
# include "../gui/IncludesSFML.h"
# include <iostream>
# include "../gui/ClickableSprite.h"
...
public:
   ...
   inline void setFocused(bool focused, Window& container){
      this->focused = focused;
      onFocusAction(container);
   }
   ...
   inline void setHovered(bool hovered, Window& container){
   ...
   inline void setEnabled(bool enabled, Window& container){
...
private:
   ...
   public:
      ...
      inline TwoPlayerButton(const Texture& t): StandardGSButton(t){
         start_pos = 0;
         updateButton();
      };
   ...
   public:
      ...
      inline VSHeuristicButton(const Texture& t) : StandardGSButton(t){
         start_pos = 110;
         updateButton();
      };
   ...
   public:
      ...
      inline Ninja1Button(const Texture& t) : StandardGSButton(t){
         start_pos = 190;
         updateButton();
      };
   ...
   public:
      ...
      inline Ninja2Button(const Texture& t) : StandardGSButton(t){
         start_pos = 270;
         updateButton();
      };
   ...
   public:
      ...
      inline Ninja3Button(const Texture& t) : StandardGSButton(t){
         start_pos = 350;
         updateButton();
      };
   ...
   public:
      ...
      inline HeuristicVSHeuristicButton(const Texture& t) : StandardGSButton(t){
         start_pos = 460;
         updateButton();
      };
   ...
   public:
      ...
      inline HeuristicVSNinjaButton(const Texture& t) : StandardGSButton(t){
         start_pos = 540;
         updateButton();
      };
   ...
   public:
      ...
      inline NinjaVSHeuristicButton(const Texture& t) : StandardGSButton(t){
         start_pos = 620;
         updateButton();
      };
   ...
   public:
      ...
      inline OnlineClientButton(const Texture& t) : StandardGSButton(t){
         start_pos = 730;
         updateButton();
      };
   ...
   public:
      ...
      inline OnlineServerButton(const Texture& t) : StandardGSButton(t){
         start_pos = 810;
         updateButton();
      };
   ...
   public:
      ...
      inline RandomPairingButton(const Texture& t) : StandardGSButton(t){
         start_pos = 890;
         updateButton();
      };
   ...
   public:
      ...
      inline PrivateRoomButton(const Texture& t) : StandardGSButton(t){
         start_pos = 970;
         updateButton();
      };
   ...
   public:
      ...
      inline UseGUIButton(const Texture& t) : StandardGSButton(t){
         start_pos = 1090;
         updateButton();
      };
   ...
   public:
      ...
      inline PlayerIDButton(const Texture& t) : StandardGSButton(t), id(1){
         start_pos = 1330;
         selected = true;
         updateButton();
      };
   ...
   public:
      ...
      inline StartGameButton(const Texture& t): StandardGSButton(t){
         start_pos = 1210;
         updateButton();
      };
