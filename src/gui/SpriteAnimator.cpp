#include "../../include/gui/SpriteAnimator.h"

void SpriteAnimator::initParameters(Transformable& s, const Vector2f& start_pos, const Vector2f& end_pos,
                                    int animation_time){
   this->sprite = &s;
...
SpriteAnimator::SpriteAnimator(Transformable& s, const Vector2f& start_pos, const Vector2f& end_pos,
                               int animation_time){
...
SpriteAnimator::SpriteAnimator(Transformable& s, const Vector2i& start_pos, const Vector2i& end_pos,
                               int animation_time){
