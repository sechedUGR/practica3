# include "../../include/gui/SpecialItemSprite.h"
...
SpecialItemSprite::SpecialItemSprite(const Texture& t, item_type type) : Sprite(t){
   this->type = type;
   this->setTextureRect(IntRect(item2textrec.at(type).at(0), item2textrec.at(type).at(1), item2textrec.at(type).at(2),
                                item2textrec.at(type).at(3)));
}
