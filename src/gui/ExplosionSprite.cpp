# include "../../include/gui/ExplosionSprite.h"
# include <cmath>
...
ExplosionAnimator::ExplosionAnimator(float baseScale, float expansionScale, int animationTime) :
   SpriteAnimator(animationTime), baseScale(baseScale), expansionScale(expansionScale){
}

ExplosionAnimator::ExplosionAnimator(Transformable& s, float baseScale, float expansionScale, int animationTime) :
   SpriteAnimator(s, s.getPosition(), s.getPosition(), animationTime), baseScale(baseScale),
