...
bool RemotePlayer::move(){
   ...
   while (!moved){
      Packet packet;
      cout << COUT_ORANGE_BOLD << "Esperando movimiento del oponente..." << COUT_NOCOLOR << endl;
      ...
      case MOVED:
         ...
         if (turn <= actual->getTurn()){
            ...
            cout << COUT_RED_BOLD << "WTF move too new. Some turns have been missed." << COUT_NOCOLOR << endl;
            break;
         }
         else{
